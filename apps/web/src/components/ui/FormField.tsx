      ...
      <div className="relative">
        ...
        <motion.input
          ...
          className={`
            ...
            ${icon ? 'pl-10' : ''}
            ${error
              ? 'border-red-300 bg-red-50 focus:ring-2 focus:ring-red-500/30 focus:border-red-500'
              : 'border-slate-200 bg-white focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400'
            }
            ${className}
          `}
          animate={{
            borderColor: focused ? (error ? '#fca5a5' : '#a5b4fc') : error ? '#fecaca' : '#e2e8f0',
          }}
          {...props}
        />
      </div>
  ...
  return (
    <div className="space-y-2 w-full">
      ...
      <motion.textarea
        ...
        className={`
          w-full px-4 py-2.5 border rounded-lg text-slate-900 placeholder-slate-400
          transition-all duration-200 focus:outline-none resize-vertical
          ${error
            ? 'border-red-300 bg-red-50 focus:ring-2 focus:ring-red-500/30 focus:border-red-500'
            : 'border-slate-200 bg-white focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400'
          }
